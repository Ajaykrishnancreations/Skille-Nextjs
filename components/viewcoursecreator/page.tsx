            ...
            <div className="p-10">
                <div className="flex">
                    <div className="w-5/6">
                        ...
                        <h3><span><Link href="/admincourseconsole">{"Back to Course < "}</Link></span>{CourseTitle}</h3>
                        :
                        <h3><span><Link href="/course">{"Back to Course < "}</Link></span>{CourseTitle}</h3>
                        }
                    </div>
                    <div className="w-1/6">
                                ...
                                <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-3">
                                    <div className="p-5">
                                        ...
                                        <div className="" style={{ position: "absolute", marginTop: "10px", paddingLeft: "14%" }}>
                                            <button style={{ width: "80px" }} className="border-4 border-white rounded bg-gray-300 z-2 w-20" onClick={() => openUpdateModal(item)}>Edit</button>
                                        </div>
