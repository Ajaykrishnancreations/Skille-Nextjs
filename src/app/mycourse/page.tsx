                            ...
                            <div key={item.id}>
                                <div className="p-5">
                                    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-3">
                                        <div className="p-5">
                                            <div className="" style={{ position: "absolute", marginTop: "10px", paddingLeft: "10%" }}>
                                                <button
                                        ...
                                        <div className="p-5 h-50">
                                            ...
                                            <Link href="/viewcourse"
                                                ...
                                                className="inline-flex items-center px-3 py-2 text-sm font-medium text-center mt-3 text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                View
